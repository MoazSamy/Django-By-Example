...
class Command(BaseCommand):
    help = 'Sends an e-mail reminder to users registered more than N days that are not enrolled in any courses yet'
    ...
    def handle(self, *args, **options):
        ...
        for user in users:
            message = """Dear {},
            We noticed you didn't enroll in any courses yet.
